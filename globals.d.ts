declare module 'node:crypto' { export function createHash(a:string): { update(v:string|Buffer): any; digest(enc:string): string }; }
declare module 'node:fs' { export function createReadStream(p:string): any; }
